...
This deploys all 3 contracts to Ganache, whitelists the relayer, and updates `.env` and `deployment.json`.
...
| Contract | Address |
|----------|--------|
| **BatchExecutor** | `0xE9f0aEF7BfA0be49A4F4Ff43FD7071081ea0680d` |
| **SampleToken** | `0x9605e4c2B6053f7befb5d8d8c5a5e9BDab9A148f` |
| **GasSponsor** | `0x8930c04455541778b6eBda6bD93d6Ec5d0eAF596` |
